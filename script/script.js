    ...
    function timeTable() {
      newHour = $("<div>")
        ...
        .attr({
          id: `hour${hour}`,
          value: `${hour}`,
          class: "box columns bigText",
        });
      submit = $("<input>").attr({
        type: "button",
        value: "save",
        id: `submit${hour}`,
        class: "button is-primary columnFlex mediumText ",
      });
      inputBoxSort = $("<input>").attr({
        type: "text",
        id: `input${hour}`,
        value: "",
        class: "input is-primary textarea",
      });
      newBox = $("<div>").attr({ class: "box" });
      hourDiv = $("<div>").attr({ id: `${hour}div` });

      mainTable.append(newHour.append(inputBoxSort, submit, hourDiv));
    }
    timeTable();
    console.log($("#hour8").text);
  });
